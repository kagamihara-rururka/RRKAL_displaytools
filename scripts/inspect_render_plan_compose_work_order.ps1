...
[ordered]@{
    ...
    source_helpers = @(
        ...
        $renderPlan.composition_apply_action_helper,
        $renderPlan.composition_dispatch_packet_helper,
        $renderPlan.composition_timing_packet_helper,
        $renderPlan.style_postprocess_packet_helper,
