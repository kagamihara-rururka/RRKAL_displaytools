...
[ordered]@{
    ...
    boundary_summary_contract_schema = $boundaryEmphasis.boundary_summary_contract_schema
    ...
    boundary_color_rgb = @($boundaryEmphasis.color_rgb)
    boundary_contrast = $boundaryEmphasis.contrast
    boundary_opacity = $boundaryEmphasis.opacity
    boundary_gamma = $boundaryEmphasis.gamma
    boundary_breathing_enabled = $boundaryEmphasis.breathing_enabled
    boundary_breathing_period_s = $boundaryEmphasis.breathing_period_s
    boundary_renderer_controls_mapped = @($boundaryEmphasis.renderer_controls_mapped)
    boundary_highlight_color_rgb = @($boundaryHighlight.color_rgb)
    boundary_highlight_alpha = $boundaryHighlight.alpha
    boundary_highlight_contrast = $boundaryHighlight.contrast
    boundary_highlight_gamma = $boundaryHighlight.gamma
    boundary_highlight_breathing = $boundaryHighlight.breathing
