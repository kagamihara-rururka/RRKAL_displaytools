...
- Boundary highlight 下一步是從目前 line hover outline/glow、source-property feature identity 與閉合 ring polygon preview 升級到 authoritative 疆域/領海/EEZ identity、開放線段面域推論，以及 fill shader 的 gamma/contrast。
