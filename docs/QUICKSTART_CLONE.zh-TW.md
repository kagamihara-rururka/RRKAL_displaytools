...
Run/profile 區的 `Export reviewer packet` 會輸出 `state/showcase/reviewer_packet.json`，包含 clone、launch、research、visual、compose performance 摘要與 launch packet snapshot。
