...
| `qt_inspector_action_ids` | array | Qt `Inspect:` action IDs，例如 `profile_replay`、`timeline`、`clone_ready`、`layer_matrix`、`layer_runtime`、`layer_pick`、`cursor_geo`、`boundary_json`。 |
